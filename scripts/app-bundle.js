...
define('components/notification/notification-box',["exports", "aurelia-framework"], function (exports, _aureliaFramework) {
  ...
  var NotificationBox = exports.NotificationBox = (_class = function () {
    ...
    NotificationBox.prototype.notificationRedirect = function notificationRedirect() {};
...
define('text!components/notification/notification-box.html', ['module'], function(module) { module.exports = "<template>\r\n\r\n<div class=\"notification-box box-bottom box-success animation-long ${notifyUser ? '' : 'animation-slide-up'}\">\r\n  <p>${notificationMessage}</p>\r\n  <a href=\"${notificationHref}\">${notificationTitle}</a>\r\n</div>\r\n\r\n</template>\r\n"; });
...
define('text!styles/notifications/utilities.css', ['module'], function(module) { module.exports = ""; });
define('text!styles/utilities.css', ['module'], function(module) { module.exports = ".overflow-x {\n  overflow-x: auto; }\n"; });
